...
public class AddGroupActivityNew extends AppCompatActivity implements AddGroupContactsAdapter.NotifyInAddGroup {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_group_layout_new);
...
//                        AddGroupContactsAdapter adapter = new AddGroupContactsAdapter(AddGroupActivityNew.this, addcontactList, user_id, crm_flag, editFlag, AddGroupActivity.this,select_all);
        ...
        tv_my_contact.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                if (checked) {
                    ...
                    if (selected_contact.size()==addcontactList.size()){
                        ch_select_all_contacts.setChecked(true);
                    }else{
                        ch_select_all_contacts.setChecked(false);
                    }
                } else {
        ...
        tv_my_prospect.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                if (checked) {
                    ...
                    if (selected_prospects.size()==addcontactList.size()){
                        ch_select_all_contacts.setChecked(true);
                    }else{
                        ch_select_all_contacts.setChecked(false);
                    }
        ...
        tv_my_customers.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                ...
                if (checked) {
                    ...
                    if (selected_customers.size()==addcontactList.size()){
                        ch_select_all_contacts.setChecked(true);
                    }else{
                        ch_select_all_contacts.setChecked(false);
                    }
        ...
        tv_my_recruits.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                ...
                if (checked) {
                    ...
                    if (selected_recruits.size()==addcontactList.size()){
                        ch_select_all_contacts.setChecked(true);
                    }else{
                        ch_select_all_contacts.setChecked(false);
                    }
                ...
                if (myValidator.isValidField(edt_group_name)) {
                    ...
                    if (selected_rb == R.id.rb_from_system) {
                        if (selected_group_contact.size() > 0) {
                            ...
                            Toast.makeText(AddGroupActivityNew.this, "Please Select at least one Contact..!", Toast.LENGTH_LONG).show();
                        }
                    }else if (selected_rb == R.id.rb_import_csv){
                        if (selected_csv_file!=null){
                            importCSVToGroup(selected_csv_file);
                        }else{
                            Toast.makeText(AddGroupActivityNew.this, "Please select file to upload", Toast.LENGTH_LONG).show();
                        }
...
//                        rv_add_group.setAdapter(adapter);
        ...
        tv_click_here.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (ContextCompat.checkSelfPermission(AddGroupActivityNew.this,
                        Manifest.permission.READ_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(AddGroupActivityNew.this,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        != PackageManager.PERMISSION_GRANTED) {

                    ActivityCompat.requestPermissions(AddGroupActivityNew.this,
                            new String[]{Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE},
                            MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE);
                    Toast.makeText(AddGroupActivityNew.this, "Write External Storage Permission Denied", Toast.LENGTH_LONG).show();
                } else {
                    downloadSampleCSV();
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                if (checked){
                    ...
                    if (!campaignId.equals("")){
                        ...
                        Toast.makeText(AddGroupActivityNew.this, "Please select campaign..!", Toast.LENGTH_LONG).show();
                    }
    ...
    private void getCampaignStatusList(String campaignId, String readFlag) {
        ...
        final Dialog myLoader = Global.showDialog(AddGroupActivityNew.this);
        myLoader.show();
...
//                            GroupCampaignAdapter adapter=new GroupCampaignAdapter(AddGroupActivityNew.this,contactList,user_id,editFlag);
//                            rv_emails_from_campaigns.setAdapter(adapter);
            ...
            public void onFailure(Call<ContactDetails> call, Throwable t) {
                ...
                rv_emails_from_campaigns.setVisibility(View.GONE);
                Toast.makeText(AddGroupActivityNew.this, "No Emails Available..", Toast.LENGTH_LONG).show();
            }
        });
            ...
            public void onResponse(Call<GetAllCampaign> call, Response<GetAllCampaign> response) {
                if (response.isSuccessful()){
                    ...
                    if (getAllCampaign.isSuccess()){
                        ...
                        Toast.makeText(AddGroupActivityNew.this, ""+getAllCampaign.getResult(), Toast.LENGTH_LONG).show();
                    }
                    myLoader.dismiss();
                }
            }
    ...
    private void applySpinner(final String[] taglist, Spinner sp_name, String tag_string) {
        ...
        AddContactActivity.spinnerAdapter adapterRepeateDaily = new AddContactActivity.spinnerAdapter(AddGroupActivityNew.this, android.R.layout.simple_list_item_1);
    ...
    private void downloadSampleCSV() {
        ...
        myLoader.dismiss();
        Toast.makeText(AddGroupActivityNew.this, "File Downloaded Successfully..!", Toast.LENGTH_LONG).show();
    ...
    private void editGroupDetails() {
        ...
        call.enqueue(new Callback<JsonResult>() {
            ...
            public void onResponse(Call<JsonResult> call, Response<JsonResult> response) {
                ...
                if (result.isSuccess()) {
                    Toast.makeText(AddGroupActivityNew.this, "Group Updated SuccessFully..!", Toast.LENGTH_LONG).show();
                    selected_contact.clear();
                    selected_customers.clear();
                    selected_prospects.clear();
                    selected_recruits.clear();
                    ...
                    Toast.makeText(AddGroupActivityNew.this, " Error in Updating Group.!", Toast.LENGTH_LONG).show();
                    finish();
                }
                myLoader.dismiss();
            }
    ...
    private void createGroup() {
        ...
        call.enqueue(new Callback<JsonResult>() {
            ...
            public void onResponse(Call<JsonResult> call, Response<JsonResult> response) {
                JsonResult result = response.body();
                if (result.isSuccess()) {
                    Toast.makeText(AddGroupActivityNew.this, "Group Created SuccessFully..!", Toast.LENGTH_LONG).show();
                    selected_contact.clear();
                    selected_customers.clear();
                    selected_prospects.clear();
                    selected_recruits.clear();
                    ...
                    Toast.makeText(AddGroupActivityNew.this, " Error in Creating Group.!", Toast.LENGTH_LONG).show();
                    finish();
                }
                myLoader.dismiss();
            }
    ...
    private void init() {
        ...
        rv_add_group.setLayoutManager(new LinearLayoutManager(AddGroupActivityNew.this));
        rv_emails_from_campaigns.setLayoutManager(new LinearLayoutManager(AddGroupActivityNew.this));
        spLib = new SPLib(AddGroupActivityNew.this);
        ...
        int itemViewType = 0;
        rv_add_group.getRecycledViewPool().setMaxRecycledViews(itemViewType, 0);
...
//        edt_group_name.setFocusableInTouchMode(true);
                    ...
                    if (contactDetails.isSuccess()) {
                        ...
                        if (addcontactList.size() > 0) {
                           ...
                           /* for (int i=0;i<addcontactList.size();i++){
                            ...
                            AddGroupContactsAdapter adapter = new AddGroupContactsAdapter(AddGroupActivityNew.this, addcontactList, user_id, crm_flag, editFlag, AddGroupActivityNew.this,select_all);
                            adapter.notifyDataSetChanged();
                            rv_add_group.setAdapter(adapter);
    ...
    public void addContactToGroup(String contact_id) {
        ...
        if (crm_flag.equals("1")) {
            ...
            Log.d(Global.TAG, "addContactToGroup selected_contact: "+selected_contact);
        } else if (crm_flag.equals("2")) {
            if (!selected_customers.contains(contact_id)) {
                selected_customers.add(contact_id);
                tv_selected_contacts.setText(selected_customers.size() + " Customers Selected");
            }
            Log.d(Global.TAG, "addContactToGroup selected_customers: "+selected_contact);
        } else if (crm_flag.equals("3")) {
            if (!selected_prospects.contains(contact_id)) {
                selected_prospects.add(contact_id);
                tv_selected_contacts.setText(selected_prospects.size() + " Prospects Selected");
            }
            Log.d(Global.TAG, "addContactToGroup selected_prospects: "+selected_contact);
        } else if (crm_flag.equals("4")) {
            if (!selected_recruits.contains(contact_id)) {
                selected_recruits.add(contact_id);
                tv_selected_contacts.setText(selected_recruits.size() + " Recruits Selected");
            }
            Log.d(Global.TAG, "addContactToGroup selected_recruits: "+selected_contact);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == CSV_REQUEST) {
                ...
                String path = FileUtils.getPath(AddGroupActivityNew.this, uri);
                Log.d("mytag", "" + path);
            ...
            public void onResponse(Call<JsonResult> call, Response<JsonResult> response) {
                if (response.isSuccessful()) {
                    ...
                    if (jsonResult.isSuccess()) {
                        Toast.makeText(AddGroupActivityNew.this, "" + jsonResult.getResult(), Toast.LENGTH_LONG).show();
                        finish();
                    } else {
                        Toast.makeText(AddGroupActivityNew.this, "" + jsonResult.getResult(), Toast.LENGTH_LONG).show();
                    }
